...
export default function CategoryPage() {
    ...
    // Safe slug handling: ensure string, decode, and lowercase
    const rawSlug = Array.isArray(params?.category) ? params.category[0] : params?.category;
    const categorySlug = decodeURIComponent(rawSlug || "default").toLowerCase();

    // Configuration Map
    const CATEGORY_CONFIG: Record<string, { title: string; dbCategory: string; image: string }> = {
        "sofas": {
            title: "Sofás",
            dbCategory: "Sofás",
        ...
        "camas": {
            ...
            dbCategory: "Descanso",
            // Using a new, high-res bedroom image
    ...
    const defaultConfig = {
        ...
        dbCategory: categorySlug,
        image: "https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?q=80&w=2000&auto=format&fit=crop"
    };

    const config = CATEGORY_CONFIG[categorySlug] || defaultConfig;
